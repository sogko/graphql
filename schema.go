...
func (gq *Schema) getPossibleTypeMap(abstractType Abstract) (typeMap map[string]bool) {
	var ok bool

	gq.typeMapMutex.RLock()
	typeMap, ok = gq.possibleTypeMap[abstractType.Name()]
	gq.typeMapMutex.RUnlock()
